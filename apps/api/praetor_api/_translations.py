...
# All Jinja-side translation tables. Kept in their own module so ui.py
# can stay focused on routes and so the React/Office surface can import
# the same source of truth once the UI rebuild lands.
